...
const BackgroundTab2 = () => {
    ...
    const viewportRem = Math.min(window.innerHeight * 1.04 / 100, window.innerWidth * 1.31 / 100)
    ...
    return(
        <>
            <Stones1 src="img/Stones1.svg" alt="Stones"/>
            ...
            <Path1 width={425} height={892} viewBox="0 0 352 892" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path 
                    style={position >= viewport - 500 && position < viewport + ( viewportRem * 100 ) ? {strokeDashoffset: 2285} : {strokeDashoffset: 4150}}
                    opacity={0.3} 
            ...
            <Meteor src="img/Meteor.svg" alt="Meteor" style={position >= viewport + ( viewportRem * 115 ) - 500 && position < viewport + ( viewportRem * 235 ) ? {opacity: "1", left: "calc(50% - 15px)", top: "calc(100vh + 205.1rem)", width: "257.88px"} : {opacity: "0", left: "calc(50% - 415px)", top: "calc(100vh + 171.9rem)", width: "0px"}}/>
            <Light3 src="img/Light1.svg" alt="Light1" style={position >= viewport + ( viewportRem * 115 ) - 500 && position < viewport + ( viewportRem * 235 ) ? {opacity: "1"} : {opacity: "0"}}/>
            <Rock27 src="img/Rock2.svg" alt="Rock2" style={position >= viewport + ( viewportRem * 115 ) - 500 && position < viewport + ( viewportRem * 235 ) ? {opacity: "1", left: "calc(50% + 290px)", top: "calc(100vh + 175rem)"} : {opacity: "0", left: "calc(50% + 490px)", top: "calc(100vh + 155rem)"}}/>

            <Path2 width={625} height={481} viewBox="0 0 375 481" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                    style={position >= viewport + ( viewportRem * 235 ) - 500 && position < viewport + ( viewportRem * 300 ) ? {strokeDashoffset: 2720} : {strokeDashoffset: 4150}}
                    opacity={0.3}  
            ...
            <Light4 src="img/Light1.svg" alt="Light1" style={position >= viewport + ( viewportRem * 235 ) - 500 && position < viewport + ( viewportRem * 300 ) ? {opacity: "1"} : {opacity: "0"}}/>

            <Twinkle1 src="img/Twinkle1.svg" alt="Twinkle1" style={position >= viewport + ( viewportRem * 300 ) - 500 && position < viewport + ( viewportRem * 405 ) ? {opacity: 1} : {opacity: 0}} />

            <UFO src="img/UFO.svg" alt="UFO" style={position >= viewport + ( viewportRem * 405 ) - 500 && position < viewport + ( viewportRem * 455 ) ? {opacity: 1, left: "calc(50% - 18rem"} : {opacity: 0, left: "calc(50% - 50rem)"}}/>
            ...
            <Ground1 src="img/Ground2.svg" alt="Ground" style={position >= ( viewportRem * 505 ) - 500 && position < viewport + ( viewportRem * 552.7 ) ? {opacity: 1, bottom: "40rem"} : {opacity: 0, bottom: "30rem"}}/>
            <Ground2 src="img/Ground2.svg" alt="Ground" style={position >= ( viewportRem * 505 ) - 500 && position < viewport + ( viewportRem * 552.7 ) ? {opacity: 1, bottom: "40rem"} : {opacity: 0, bottom: "30rem"}}/>
            <Gradient/>
        </>
    );
};
...
animation: ${stones1Animation} 2s linear infinite;  
z-index: 1;
`

const rock18Animation = keyframes`
0% {
    top: calc(100vh + 30.5rem);
}

50% {
    top: calc(100vh + 34.5rem);
}
...
const rock16Animation = keyframes`
    0% {
        top: calc(100vh + 31.2rem);
    }

    50% {
        top: calc(100vh + 28.2rem);
    }
...
const rock6Animation = keyframes`
    0% {
        top: calc(100vh + 45.2rem);
    }

    50% {
        top: calc(100vh + 42.2rem);
    }
...
const rock13Animation = keyframes`
    0% {
        top: calc(100vh + 57.6rem);
    }

    50% {
        top: calc(100vh + 62.6rem);
    }
...
const rock8Animation = keyframes`
    0% {
        top: calc(100vh + 64.6rem);
    }

    50% {
        top: calc(100vh + 59.6rem);
    }
...
const rock19Animation = keyframes`
    0% {
        top: calc(100vh + 99.4rem);
    }

    50% {
        top: calc(100vh + 106.4rem);
    }
...
const rock20Animation = keyframes`
    0% {
        top: calc(100vh + 85.2rem);
    }

    50% {
        top: calc(100vh + 90.2rem);
    }
...
const rock15Animation = keyframes`
    0% {
        top: calc(100vh + 97.2rem);
    }

    50% {
        top: calc(100vh + 104.2rem);
    }
